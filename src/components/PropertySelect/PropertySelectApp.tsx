        ...
        <div className="MuiContainer-root">
          <div style={{ maxWidth: '600px', margin: '0 auto' }}>
            ...
            <div className="MuiAlert-root">
              ...
              <div
                className="MuiTypography-root"
                style={{ fontSize: '1rem', margin: 0, color: '#b91c1c' }}
              >
      ...
      {showUrlModal && (
        ...
        >
          ...
          >
            ...
            >
              GAS Web App URLが設定されていません。Google Apps ScriptのWeb App
              URLを入力してください。
            </p>
            <input
              type="text"
      ...
      {isNavigating && (
        ...
        >
          ...
          >
            <div className="MuiCircularProgress-root"></div>
            <div
              style={{ fontSize: '1rem', fontWeight: 500, color: 'var(--mui-palette-grey-900)' }}
            >
        ...
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          ...
          {loading && isFetched && (
            ...
            >
              ...
              ></div>
              <div style={{ fontSize: '0.875rem', color: 'var(--mui-palette-grey-900)' }}>
                処理中...
              </div>
            </div>
          )}
